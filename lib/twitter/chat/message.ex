defmodule Twitter.Chat.Message do
  use Ash.Resource,
    otp_app: :twitter,
    domain: Twitter.Chat,
    extensions: [AshOban],
  ...
  attributes do
    ...
    attribute :source, Twitter.Chat.Message.Types.Source do
      allow_nil? false
      public? true
      default :user
    end
  ...
  relationships do
    belongs_to :conversation, Twitter.Chat.Conversation do
      public? true
      allow_nil? false
    end
  ...
  actions do
    ...
    create :create do
      ...
      change Twitter.Chat.Message.Changes.CreateConversationIfNotProvided
    ...
    update :respond do
      ...
      transaction? false
      change Twitter.Chat.Message.Changes.Respond
    end
  ...
  oban do
    triggers do
      trigger :respond do
        actor_persister Twitter.AiAgentActorPersister
        action :respond
        queue :chat_responses
        lock_for_update? false
        scheduler_cron false
        worker_module_name Twitter.Chat.Message.Workers.Respond
        scheduler_module_name Twitter.Chat.Message.Schedulers.Respond
